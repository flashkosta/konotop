//TODO: [x]сделать удаление fen нотации
    ...
    function figureAnimation(figure, color, size, fromX, fromY, toX, toY) { //#################### анимация фишуры при ходе компьютера ####################
    ...
    function arrowDraw(from, to, result) { //#################### рисование стрелки ####################
        ...
        if (from == undefined) {
            ...
            figureAnimation(result.piece, result.color, square_wh, x_start, y_start, x_end, y_end);
